-- ============================================================
-- Hệ thống Quản lý Kho VLXD
-- Database: vatlieu (gộp toàn bộ bảng từ các microservice)
-- Chạy: mysql -u root -p < database/vatlieu.sql
...
-- ------------------------------------------------------------
-- Sản phẩm & nguyên vật liệu (product-service)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Kho & chứng từ (warehouse-service)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Sản xuất (manufacturing-service)
-- ------------------------------------------------------------
...
-- Th�m t�i kho?n admin m?c d?nh d? dang nh?p
INSERT INTO Nguoidung (Manv, Tendangnhap, Matkhau, Hovaten, Email, Vaitro)
VALUES ('NV001', 'admin', '123456', 'Qu?n tr? vi�n', 'admin@vlxd.com', 'admin')
